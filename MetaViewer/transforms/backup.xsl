...
<xsl:stylesheet version="1.0" exclude-result-prefixes="xs xsl xtsm_viewer" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="*[not(*)]" priority="-2">
    <li>
      <div>
        ...
        <a class="nonstandard" title="Non-standard XTSM tag." style="background-color:yellow;">
  ...
  <xsl:template match="*[*]" priority="-2">
    <li>
      <div>
        ...
        <a class="nonstandard" style="background-color:pink;" title="nonstandard xtsm element.">
  ...
  <xsl:template match="head"><li><div><xsl:call-template name="topline_preamble" /><xsl:call-template name="repeat"><xsl:with-param name="count" select="20- string-length(name(.))" /><xsl:with-param name="output">.</xsl:with-param></xsl:call-template><xsl:call-template name="toolpanel" /></div><div><xsl:call-template name="child_div" /></div></li></xsl:template>
	...
	<xsl:template match="PreParseInstructions"><li><div><xsl:call-template name="topline_preamble" /><xsl:call-template name="repeat"><xsl:with-param name="count" select="20- string-length(name(.))" /><xsl:with-param name="output">.</xsl:with-param></xsl:call-template><xsl:call-template name="toolpanel" /></div><div><xsl:call-template name="child_div" /></div></li></xsl:template>

	<xsl:template match="PostParseInstructions"><li><div><xsl:call-template name="topline_preamble" /><xsl:call-template name="repeat"><xsl:with-param name="count" select="20- string-length(name(.))" /><xsl:with-param name="output">.</xsl:with-param></xsl:call-template><xsl:call-template name="toolpanel" /></div><div><xsl:call-template name="child_div" /></div></li></xsl:template>

	<xsl:template match="ParserCommand"><li><div><xsl:call-template name="topline_preamble" /><xsl:call-template name="repeat"><xsl:with-param name="count" select="20- string-length(name(.))" /><xsl:with-param name="output">.</xsl:with-param></xsl:call-template><xsl:for-each select="Name"><xsl:call-template name="gen_input_field" /></xsl:for-each><xsl:call-template name="toolpanel" /></div><div><div><xsl:call-template name="child_div" /></div></div></li></xsl:template>
  ...
  <xsl:template match="Edge"><li><div><xsl:call-template name="topline_preamble" /><xsl:call-template name="repeat"><xsl:with-param name="count" select="20- string-length(name(.))" /><xsl:with-param name="output">.</xsl:with-param></xsl:call-template><xsl:for-each select="Time | Value"><xsl:call-template name="gen_input_field" /></xsl:for-each><xsl:call-template name="toolpanel" /></div><div><xsl:call-template name="child_div" /></div></li></xsl:template>
   ...
   <xsl:template match="ParserInstructions"><li><div><xsl:call-template name="topline_preamble" /><xsl:call-template name="repeat"><xsl:with-param name="count" select="20- string-length(name(.))" /><xsl:with-param name="output">.</xsl:with-param></xsl:call-template><xsl:for-each select="Name | GroupNumber"><xsl:call-template name="gen_input_field" /></xsl:for-each><xsl:call-template name="toolpanel" /></div><div><div><xsl:call-template name="child_div" /></div></div></li></xsl:template>
  ...
  <xsl:template match="RepresentAsInteger"><li><div><xsl:attribute name="gen_id"><xsl:call-template name="treeid" /></xsl:attribute><input type="checkbox"><xsl:attribute name="xtsm_viewer_event">onclick:toggleProp_update_editor('disable');</xsl:attribute><xsl:if test="not(@disable) or @disable!='1'"><xsl:attribute name="checked">checked</xsl:attribute></xsl:if></input><xsl:call-template name="gen_input_field" /><xsl:call-template name="toolpanel" /></div></li></xsl:template>

  <xsl:template match="SparseControlArray"><li><div><xsl:attribute name="gen_id"><xsl:call-template name="treeid" /></xsl:attribute><input type="checkbox"><xsl:attribute name="xtsm_viewer_event">onclick:toggleProp_update_editor('disable');</xsl:attribute><xsl:if test="not(@disable) or @disable!='1'"><xsl:attribute name="checked">checked</xsl:attribute></xsl:if></input><xsl:call-template name="gen_input_field" /><xsl:call-template name="toolpanel" /></div></li></xsl:template>

  <xsl:template match="Pulser"><li><div><xsl:attribute name="gen_id"><xsl:call-template name="treeid" /></xsl:attribute><input type="checkbox"><xsl:attribute name="xtsm_viewer_event">onclick:toggleProp_update_editor('disable');</xsl:attribute><xsl:if test="not(@disable) or @disable!='1'"><xsl:attribute name="checked">checked</xsl:attribute></xsl:if></input><xsl:call-template name="gen_input_field" /><xsl:call-template name="toolpanel" /></div></li></xsl:template>

  <xsl:template match="ActiveClockEdge"><li><div><xsl:attribute name="gen_id"><xsl:call-template name="treeid" /></xsl:attribute><input type="checkbox"><xsl:attribute name="xtsm_viewer_event">onclick:toggleProp_update_editor('disable');</xsl:attribute><xsl:if test="not(@disable) or @disable!='1'"><xsl:attribute name="checked">checked</xsl:attribute></xsl:if></input><xsl:call-template name="gen_input_field" /><xsl:call-template name="toolpanel" /></div></li></xsl:template>
