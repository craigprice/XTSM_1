...
<xsl:stylesheet version="1.0" exclude-result-prefixes="xs xsl xtsm_viewer" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template name="gen_input_textarea">
  ...
  <xsl:template match="ExecuteOnEvent"><li><div><xsl:attribute name="gen_id"><xsl:call-template name="treeid" /></xsl:attribute><input type="checkbox"><xsl:attribute name="xtsm_viewer_event">onclick:toggleProp_update_editor('disable');</xsl:attribute><xsl:if test="not(@disable) or @disable!='1'"><xsl:attribute name="checked">checked</xsl:attribute></xsl:if></input><xsl:call-template name="gen_input_field" /><xsl:call-template name="toolpanel" /></div></li></xsl:template>

  <xsl:template match="ScriptConsole"><li><div><xsl:call-template name="topline_preamble" /><xsl:call-template name="repeat"><xsl:with-param name="count" select="20- string-length(name(.))" /><xsl:with-param name="output">.</xsl:with-param></xsl:call-template><xsl:call-template name="toolpanel" /></div><div><xsl:choose><xsl:when test="@expanded='1'"><xsl:call-template name="child_div" /></xsl:when><xsl:otherwise /></xsl:choose></div></li></xsl:template>


  <xsl:template match="Type"><li><div><xsl:attribute name="gen_id"><xsl:call-template name="treeid" /></xsl:attribute><input type="checkbox"><xsl:attribute name="xtsm_viewer_event">onclick:toggleProp_update_editor('disable');</xsl:attribute><xsl:if test="not(@disable) or @disable!='1'"><xsl:attribute name="checked">checked</xsl:attribute></xsl:if></input><xsl:call-template name="gen_input_field" /><xsl:call-template name="toolpanel" /></div></li></xsl:template>

  <xsl:template match="ExecuteOnMainServer"><li><div><xsl:attribute name="gen_id"><xsl:call-template name="treeid" /></xsl:attribute><input type="checkbox"><xsl:attribute name="xtsm_viewer_event">onclick:toggleProp_update_editor('disable');</xsl:attribute><xsl:if test="not(@disable) or @disable!='1'"><xsl:attribute name="checked">checked</xsl:attribute></xsl:if></input><xsl:call-template name="gen_input_field" /><xsl:call-template name="toolpanel" /></div></li></xsl:template>

  <xsl:template match="Remote"><li><div><xsl:attribute name="gen_id"><xsl:call-template name="treeid" /></xsl:attribute><input type="checkbox"><xsl:attribute name="xtsm_viewer_event">onclick:toggleProp_update_editor('disable');</xsl:attribute><xsl:if test="not(@disable) or @disable!='1'"><xsl:attribute name="checked">checked</xsl:attribute></xsl:if></input><xsl:call-template name="gen_input_field" /><xsl:call-template name="toolpanel" /></div></li></xsl:template>

  <xsl:template match="XPath"><li><div><xsl:attribute name="gen_id"><xsl:call-template name="treeid" /></xsl:attribute><input type="checkbox"><xsl:attribute name="xtsm_viewer_event">onclick:toggleProp_update_editor('disable');</xsl:attribute><xsl:if test="not(@disable) or @disable!='1'"><xsl:attribute name="checked">checked</xsl:attribute></xsl:if></input><xsl:call-template name="gen_input_field" /><xsl:call-template name="toolpanel" /></div></li></xsl:template>

  <xsl:template match="DataGUI"><li><div><xsl:call-template name="topline_preamble" /><xsl:call-template name="repeat"><xsl:with-param name="count" select="20- string-length(name(.))" /><xsl:with-param name="output">.</xsl:with-param></xsl:call-template><xsl:for-each select="Name"><xsl:call-template name="gen_input_field" /></xsl:for-each><xsl:call-template name="toolpanel" /></div><div><xsl:choose><xsl:when test="@expanded='1'"><xsl:call-template name="child_div" /></xsl:when><xsl:otherwise /></xsl:choose></div></li></xsl:template>

  <xsl:template match="ScriptBody"><li><div><xsl:attribute name="gen_id"><xsl:call-template name="treeid" /></xsl:attribute><input type="checkbox"><xsl:attribute name="xtsm_viewer_event">onclick:toggleProp_update_editor('disable');</xsl:attribute><xsl:if test="not(@disable) or @disable!='1'"><xsl:attribute name="checked">checked</xsl:attribute></xsl:if></input><xsl:call-template name="toolpanel" /><xsl:call-template name="gen_input_textarea"><xsl:with-param name="editmode">python</xsl:with-param></xsl:call-template></div></li></xsl:template>

  <xsl:template match="Method"><li><div><xsl:attribute name="gen_id"><xsl:call-template name="treeid" /></xsl:attribute><input type="checkbox"><xsl:attribute name="xtsm_viewer_event">onclick:toggleProp_update_editor('disable');</xsl:attribute><xsl:if test="not(@disable) or @disable!='1'"><xsl:attribute name="checked">checked</xsl:attribute></xsl:if></input><xsl:call-template name="toolpanel" /><xsl:call-template name="gen_input_textarea"><xsl:with-param name="editmode">python</xsl:with-param></xsl:call-template></div></li></xsl:template>
  ...
  <xsl:template match="PullFrom"><li><div><xsl:call-template name="topline_preamble" /><xsl:call-template name="repeat"><xsl:with-param name="count" select="20- string-length(name(.))" /><xsl:with-param name="output">.</xsl:with-param></xsl:call-template><xsl:for-each select="Name"><xsl:call-template name="gen_input_field" /></xsl:for-each><xsl:call-template name="toolpanel" /></div><div><xsl:choose><xsl:when test="@expanded='1'"><xsl:call-template name="child_div" /></xsl:when><xsl:otherwise /></xsl:choose></div></li></xsl:template>

  <xsl:template match="AnalysisSpace"><li><div><xsl:call-template name="topline_preamble" /><xsl:call-template name="repeat"><xsl:with-param name="count" select="20- string-length(name(.))" /><xsl:with-param name="output">.</xsl:with-param></xsl:call-template><xsl:for-each select="Name"><xsl:call-template name="gen_input_field" /></xsl:for-each><xsl:call-template name="toolpanel" /></div><div><xsl:choose><xsl:when test="@expanded='1'"><xsl:call-template name="child_div" /></xsl:when><xsl:otherwise /></xsl:choose></div></li></xsl:template>
  ...
  <xsl:template match="Instrument"><li><div><xsl:call-template name="topline_preamble" /><xsl:call-template name="repeat"><xsl:with-param name="count" select="20- string-length(name(.))" /><xsl:with-param name="output">.</xsl:with-param></xsl:call-template><xsl:for-each select="OnInstrument"><xsl:call-template name="gen_input_field" /></xsl:for-each><xsl:call-template name="toolpanel" /></div><div><xsl:choose><xsl:when test="@expanded='1'"><xsl:call-template name="child_div" /></xsl:when><xsl:otherwise /></xsl:choose></div></li></xsl:template>

  <xsl:template match="OnInstrument"><li><div><xsl:attribute name="gen_id"><xsl:call-template name="treeid" /></xsl:attribute><input type="checkbox"><xsl:attribute name="xtsm_viewer_event">onclick:toggleProp_update_editor('disable');</xsl:attribute><xsl:if test="not(@disable) or @disable!='1'"><xsl:attribute name="checked">checked</xsl:attribute></xsl:if></input><xsl:call-template name="gen_input_field" /><xsl:call-template name="toolpanel" /></div></li></xsl:template>


  <xsl:template match="InstrumentCommand"><li><div><xsl:call-template name="topline_preamble" /><xsl:call-template name="repeat"><xsl:with-param name="count" select="20- string-length(name(.))" /><xsl:with-param name="output">.</xsl:with-param></xsl:call-template><xsl:for-each select="OnInstrument | Name"><xsl:call-template name="gen_input_field" /></xsl:for-each><xsl:call-template name="toolpanel" /></div><div><xsl:choose><xsl:when test="@expanded='1'"><xsl:call-template name="child_div" /></xsl:when><xsl:otherwise /></xsl:choose></div></li></xsl:template>
  ...
  <xsl:template match="ServerIPAddress"><li><div><xsl:attribute name="gen_id"><xsl:call-template name="treeid" /></xsl:attribute><input type="checkbox"><xsl:attribute name="xtsm_viewer_event">onclick:toggleProp_update_editor('disable');</xsl:attribute><xsl:if test="not(@disable) or @disable!='1'"><xsl:attribute name="checked">checked</xsl:attribute></xsl:if></input><xsl:call-template name="gen_input_field" /><xsl:call-template name="toolpanel" /></div></li></xsl:template>
