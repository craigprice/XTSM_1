...
class GlabPythonManager():
    ...
    def __init__(self):
        ...
        exec(server_initializations.initializations[uuid.getnode()]) in globals(), locals()
    ...
    def locate_peers(self):
        """
        looks on local network for other XTSM servers, attaches a list of them
        under self.XTSMServerPeers
        """
        
    
    def send(self,address,data):
        """
        sends data to a specified ip:port address, using existing connection
