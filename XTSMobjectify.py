...
#        
        #try: 
        #    if self.chanObj.TimingGroupIndex.PCDATA==u'12': pdb.set_trace() 
        #except: pass          
...
class Script(gnosis.xml.objectify._XO_,XTSM_core):
    ...
    def _find_dependencies(self):
        ...
        for dep in self.dependencies: # check if dependent is an acceptable python module - if so, don't need to listen for it
